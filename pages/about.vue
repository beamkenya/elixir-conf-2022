    ...
    <div class="d-container">
     <shared-banner>About</shared-banner>
      ...
      <div class="py-4 lg:py-10">
        <p>ElixirConfAfr is an annual conference bringing together BEAM enthusiasts for collaboration, networking and learning.
          <br><br>
          ...
          <br><br>
          ElixConfAfr will be held at Greenwich Meridian Time (GMT) to suit attendees all over Africa for a two-day event filled with display of talks and workshops from amazing speakers and teachers.</p>
      </div>
    </div>
  </div>
</template>
