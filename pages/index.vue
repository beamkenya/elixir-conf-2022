<template>
  <div>
    <div class="d-container">
      ...
      <section id="about" class="mt-10 md:mt-32">
        <div class="row">
          <div class="w-full md:w-1/3">
            <img src="/images/logo-purple-square.png" alt="logo 2">
          </div>
